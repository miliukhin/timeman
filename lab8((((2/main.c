...
int main(){
    ...
    readstruc(c);
    char q[5];
    printf("Enter a to append  c to change f to find p to show elements  s to sort element  d to delete element e to exit: \n");
    scanf("%s",q);
    switch ( q[0] ){
